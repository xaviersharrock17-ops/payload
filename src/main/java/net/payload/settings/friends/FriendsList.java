package net.payload.settings.friends;
...
public class FriendsList {
	...
	public FriendsList() {
		File configFolder = new File(MinecraftClient.getInstance().runDirectory, "payload");
	...
	public void removeFriend(String username) {
		friendsList.removeIf(friend -> friend.getUsername().equalsIgnoreCase(username));
	}
