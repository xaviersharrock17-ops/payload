 ...
 */
package net.payload.altmanager;

import com.google.common.reflect.TypeToken;
import com.google.gson.*;
import com.mojang.logging.LogUtils;
import net.payload.PayloadClient;
import net.payload.altmanager.login.MicrosoftAuth;
import net.payload.mixin.interfaces.IMinecraftClient;
import net.payload.utils.system.HWIDUtil;
...
public class AltManager {
    ...
    public void readAlts() {
        try {
            ...
            File altFile = new File("payload_alts.json");
            if (!altFile.exists()) {
    ...
    public void saveAlts() {
        try {
            // Finds the file and opens it.
            File altFile = new File("payload_alts.json");
            LogUtils.getLogger().info("[Payload] Saving Alts");
            ...
            LogUtils.getLogger().error("[Payload] Failed to save alts");
            exception.printStackTrace();
        }
    }
