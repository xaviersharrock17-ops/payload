...
public class ObfuscatedOptionsWindow extends Window {

    public ObfuscatedOptionsWindow() {
        super("ObfuscatedOptions", 500, 250);
        ...
        stackPanel.addChild(new StringComponent("ObfuscatedArrayList", GuiManager.foregroundColor.getValue(), false));
        this.addChild(stackPanel);
        stackPanel.addChild(new ColorPickerComponent(GuiManager.obfarraylistcolor));
        SliderComponent slider = new SliderComponent(FakeArrayScale);
