...
import net.payload.gui.components.CheckboxComponent;
import net.payload.gui.components.EnumComponent;
import net.payload.gui.components.SeparatorComponent;
import net.payload.gui.components.SliderComponent;
...
import net.payload.pathfinding.AbstractPathManager;
import net.payload.pathfinding.FlyPathManager;
import net.payload.pathfinding.PathNode;
import net.payload.pathfinding.TeleportPathManager;
import net.payload.pathfinding.WalkingPathManager;
	...
	public void onRender(Render3DEvent event) {
		if (this.nodes != null) {
			...
			for (int i = 0; i < nodes.size() - 1; i++) {
				...
				Render3D.drawLine3D(event.GetMatrix(), event.getCamera(), first.pos.toCenterPos(), second.pos.toCenterPos(), Colors.Red,
						1.0f);
			}
		}
	}
