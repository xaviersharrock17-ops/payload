...
public class HudColorPickerComponent extends Component {
    ...
    public HudColorPickerComponent(ColorSetting color) {
        super();
    ...
    public void draw(DrawContext drawContext, float partialTicks) {
        ...
        float actualWidth = this.getActualSize().getWidth();
        float actualHeight = this.getActualSize().getHeight();
        /// enumerator hitbox visualizer
        /// Render2D.drawBoxOutline(matrix4f, actualX + actualWidth - 228, actualY + 38, 234, 24, GuiManager.borderColor.getValue());
        Render2D.drawString(drawContext, this.text, actualX+1, Math.round(actualY + 14), 0xFFFFFF);
        ...
        if (!collapsed) {
            ...
            Render2D.drawString(drawContext, enumText, actualX+40 + actualWidth - 75 - stringLength, Math.round(actualY + 40), 0x9B9B9B);
