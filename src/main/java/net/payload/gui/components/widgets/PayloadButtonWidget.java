package net.payload.gui.components.widgets;
...
public class PayloadButtonWidget extends PressableWidget {
    private Consumer<PayloadButtonWidget> pressAction;
    private long hoverStartTime = 0;
    private static final long HOVER_ANIMATION_DURATION = 200000000;

    public PayloadButtonWidget(int x, int y, int width, int height, Text message) {
        super(x, y, width, height, message);
    }

    public void setPressAction(Consumer<PayloadButtonWidget> pressAction) {
    ...
    protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Render2D.drawOutlinedRoundedBox(matrix, getX(), getY(), width, height, GuiManager.roundingRadius.getValue(), outlineColor, boxColor);
